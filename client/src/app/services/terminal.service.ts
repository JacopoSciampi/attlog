...
export class TerminalService {
    ...
    public addTerminal(c_sn: string, c_name: string, c_model: string, fk_customer_name: string, c_desc: string) {
    ...
    public updateTerminal(c_sn: string, c_name: string, c_model: string, fk_customer_name: string, c_desc: string) {
